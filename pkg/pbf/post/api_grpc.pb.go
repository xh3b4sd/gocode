...
type APIClient interface {
	...
	Foo(ctx context.Context, in *UpdateI, opts ...grpc.CallOption) (*UpdateO, error)
}
...
func (c *aPIClient) Create(ctx context.Context, in *CreateI, opts ...grpc.CallOption) (*CreateO, error) {
	out := new(CreateO)
	err := c.cc.Invoke(ctx, "/post.API/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Delete(ctx context.Context, in *DeleteI, opts ...grpc.CallOption) (*DeleteO, error) {
	out := new(DeleteO)
	err := c.cc.Invoke(ctx, "/post.API/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Search(ctx context.Context, in *SearchI, opts ...grpc.CallOption) (*SearchO, error) {
	out := new(SearchO)
	err := c.cc.Invoke(ctx, "/post.API/Search", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Update(ctx context.Context, in *UpdateI, opts ...grpc.CallOption) (*UpdateO, error) {
	out := new(UpdateO)
	err := c.cc.Invoke(ctx, "/post.API/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Foo(ctx context.Context, in *UpdateI, opts ...grpc.CallOption) (*UpdateO, error) {
	out := new(UpdateO)
	err := c.cc.Invoke(ctx, "/post.API/Foo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServer interface {
	...
	Foo(context.Context, *UpdateI) (*UpdateO, error)
...
func (UnimplementedAPIServer) Foo(context.Context, *UpdateI) (*UpdateO, error) {
...
func _API_Foo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateI)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).Foo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/post.API/Foo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).Foo(ctx, req.(*UpdateI))
	}
	return interceptor(ctx, in, info, handler)
}
