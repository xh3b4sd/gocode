...
type APIClient interface {
	...
	Test(ctx context.Context, in *UpdateI, opts ...grpc.CallOption) (*UpdateO, error)
}
...
func (c *aPIClient) Test(ctx context.Context, in *UpdateI, opts ...grpc.CallOption) (*UpdateO, error) {
	out := new(UpdateO)
	err := c.cc.Invoke(ctx, "/post.API/Test", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServer interface {
	...
	Test(context.Context, *UpdateI) (*UpdateO, error)
...
func (UnimplementedAPIServer) Test(context.Context, *UpdateI) (*UpdateO, error) {
...
func _API_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/post.API/Test",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).Test(ctx, req.(*UpdateI))
	}
	return interceptor(ctx, in, info, handler)
}
